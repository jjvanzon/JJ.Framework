...
/// Collects <see cref="ValidationMessage" /> entries and supports composing sub-validators.
/// </summary>
...
/// <summary>
/// A single validation result consisting of a property key (for UI binding)
/// and a human-readable message.
/// </summary>
public struct _validationmessage;

/// <summary>
/// A collection of <see cref="ValidationMessage" /> objects.
/// Supports enumeration, indexed access and bulk additions.
/// </summary>
...
// ── ValidatorBase / IValidator members ───────────────────────────────
...
/// <summary>
/// The validation messages collected during execution.
/// </summary>
public struct _validationmessagesprop;
...
/// </summary>
public struct _executesubvalidator;
...
/// </remarks>
public struct _executesameobject;
...
/// </param>
public struct _messageprefix;

// ── FluentValidator members ──────────────────────────────────────────
...
/// A technical key identifying the property,
/// used e.g. by MVC to show messages next to the matching input element.
/// </param>
public struct _for;
