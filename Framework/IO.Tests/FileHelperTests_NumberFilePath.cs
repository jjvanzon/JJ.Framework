...
[TestClass]
public class FileHelperTests_NumberedFilePath
{
    [TestMethod]
    public void Test_FileHelper_GetNumberedFilePath_ConditionViolation_BaseFilePathNullOrEmpty()
    {
        Throws(() =>
    ...
    [TestMethod]
    public void Test_FileHelper_GetNumberedFilePath_FirstFileNotNumbered()
    {
    ...
    [TestMethod]
    public void Test_FileHelper_GetNumberedFilePath_FirstFileNumbered()
    {
    ...
    [TestMethod]
    public void Test_FileHelper_GetNumberedFilePath_FirstFileNotNumbered_TwoFiles()
    {
        string folderPath = TestHelper.GenerateFolderPath();
        string baseFilePath = Path.Combine(folderPath, "temp.txt");
    ...
    [TestMethod]
    public void Test_FileHelper_GetNumberedFilePath_FirstFileNumbered_TwoFiles()
    {
        string folderPath = TestHelper.GenerateFolderPath();
        string baseFilePath = Path.Combine(folderPath, "temp.txt");
    ...
    [TestMethod]
    public void Test_FileHelper_GetNumberedFilePath_AlternativeNumberFormat()
    {
        string folderPath = TestHelper.GenerateFolderPath();
        Directory.CreateDirectory(folderPath);
        string baseFilePath = Path.Combine(folderPath, "temp.txt");
    ...
    [TestMethod]
    public void Test_FileHelper_GetNumberedFilePath_Try12Files()
    {
        string folderPath = TestHelper.GenerateFolderPath();
        string baseFilePath = Path.Combine(folderPath, "temp.txt");
    ...
    [TestMethod]
    public void Test_FileHelper_GetNumberedFilePath_RelativePath()
    {
        string folderPath = TestHelper.GenerateFolderPath();
    ...
    // Commented out: not great in security-constrained environment.
    //[TestMethod]
