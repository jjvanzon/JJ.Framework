...
{
    public class MyDerivedClassAccessor_UsingExpressions
    {
        private MyDerivedClass Object;
        private Accessor Accessor;
        private Accessor BaseAccessor;

        public MyDerivedClassAccessor_UsingExpressions(MyDerivedClass obj)
        {
            Object = obj;
        ...
        {
            get { return Accessor.GetPropertyValue(() => MemberToHide); }
            set { Accessor.SetPropertyValue(() => MemberToHide, value); }
        }

        public int Field
        {
            get { return BaseAccessor.GetFieldValue(() => Field); }
