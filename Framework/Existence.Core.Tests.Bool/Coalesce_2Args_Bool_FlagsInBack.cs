...
Throws(() => NoNullRet(false, Coalesce( NullyFalse, NullBool,                true )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, Coalesce( False,      NullBool,                true )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, Coalesce( NullBool,   NullyFalse,              true )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, Coalesce( False,      NullyFalse,              true )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, Coalesce( NullyFalse, NullyTrue,               true )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, Coalesce( False,      NullyTrue,               true )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, Coalesce( NullBool,   False,                   true )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, Coalesce( NullyFalse, False,                   true )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, Coalesce( NullyFalse, True,                    true )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, Coalesce( False,      True,                    true )), "Actual <True>"); // Not a flag
    }
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(  NullBool,                true )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, False     .Coalesce(  NullBool,                true )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullBool  .Coalesce(  NullyFalse,              true )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, False     .Coalesce(  NullyFalse,              true )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(  NullyTrue,               true )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, False     .Coalesce(  NullyTrue,               true )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullBool  .Coalesce(  False,                   true )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(  False,                   true )), "Actual <True>"); // Not a flag
