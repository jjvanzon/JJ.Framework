...
public class BasicType_Enum_Tests
{
    ...
    [TestMethod]
    public void Test_Enum_IsNully_Extensions_ZeroMatters()
    {
        IsTrue (With0_Null        .IsNully (                   ));
        IsTrue (With0_Null        .IsNully ( zeroMatters: false));
        IsTrue (With0_Null        .IsNully (              false));
        IsTrue (With0_Null        .IsNully ( zeroMatters       ));
        IsTrue (With0_Null        .IsNully ( zeroMatters: true ));
        IsTrue (With0_Null        .IsNully (              true ));
        IsTrue (With0_Default     .IsNully (                   ));
        IsTrue (With0_Default     .IsNully ( zeroMatters: false));
        IsTrue (With0_Default     .IsNully (              false));
        IsFalse(With0_Default     .IsNully ( zeroMatters       ));
        IsFalse(With0_Default     .IsNully ( zeroMatters: true ));
        IsFalse(With0_Default     .IsNully (              true ));
        IsTrue (With0_DefaultNully.IsNully (                   ));
        IsTrue (With0_DefaultNully.IsNully ( zeroMatters: false));
        IsTrue (With0_DefaultNully.IsNully (              false));
        IsTrue (With0_DefaultNully.IsNully ( zeroMatters       ));
        IsTrue (With0_DefaultNully.IsNully ( zeroMatters: true ));
        IsTrue (With0_DefaultNully.IsNully (              true ));
        IsTrue (ZeroFirst         .IsNully (                   ));
        IsTrue (ZeroFirst         .IsNully ( zeroMatters: false));
        IsTrue (ZeroFirst         .IsNully (              false));
        IsFalse(ZeroFirst         .IsNully ( zeroMatters       ));
        IsFalse(ZeroFirst         .IsNully ( zeroMatters: true ));
        IsFalse(ZeroFirst         .IsNully (              true ));
        IsTrue (ZeroFirst_Nully   .IsNully (                   ));
        IsTrue (ZeroFirst_Nully   .IsNully ( zeroMatters: false));
        IsTrue (ZeroFirst_Nully   .IsNully (              false));
        IsFalse(ZeroFirst_Nully   .IsNully ( zeroMatters       ));
        IsFalse(ZeroFirst_Nully   .IsNully ( zeroMatters: true ));
        IsFalse(ZeroFirst_Nully   .IsNully (              true ));
        IsFalse(OneLast           .IsNully (                   ));
        IsFalse(OneLast           .IsNully ( zeroMatters: false));
        IsFalse(OneLast           .IsNully (              false));
        IsFalse(OneLast           .IsNully ( zeroMatters       ));
        IsFalse(OneLast           .IsNully ( zeroMatters: true ));
        IsFalse(OneLast           .IsNully (              true ));
        IsFalse(OneLast_Nully     .IsNully (                   ));
        IsFalse(OneLast_Nully     .IsNully ( zeroMatters: false));
        IsFalse(OneLast_Nully     .IsNully (              false));
        IsFalse(OneLast_Nully     .IsNully ( zeroMatters       ));
        IsFalse(OneLast_Nully     .IsNully ( zeroMatters: true ));
        IsFalse(OneLast_Nully     .IsNully (              true ));
        IsTrue (No0_Null          .IsNully (                   ));
        IsTrue (No0_Null          .IsNully ( zeroMatters: false));
        IsTrue (No0_Null          .IsNully (              false));
        IsTrue (No0_Null          .IsNully ( zeroMatters       ));
        IsTrue (No0_Null          .IsNully ( zeroMatters: true ));
        IsTrue (No0_Null          .IsNully (              true ));
        IsTrue (No0_Default       .IsNully (                   ));
        IsTrue (No0_Default       .IsNully ( zeroMatters: false));
        IsTrue (No0_Default       .IsNully (              false));
        IsFalse(No0_Default       .IsNully ( zeroMatters       ));
        IsFalse(No0_Default       .IsNully ( zeroMatters: true ));
        IsFalse(No0_Default       .IsNully (              true ));
        IsTrue (No0_DefaultNully  .IsNully (                   ));
        IsTrue (No0_DefaultNully  .IsNully ( zeroMatters: false));
        IsTrue (No0_DefaultNully  .IsNully (              false));
        IsTrue (No0_DefaultNully  .IsNully ( zeroMatters       ));
        IsTrue (No0_DefaultNully  .IsNully ( zeroMatters: true ));
        IsTrue (No0_DefaultNully  .IsNully (              true ));
        IsFalse(OneFirst          .IsNully (                   ));
        IsFalse(OneFirst          .IsNully ( zeroMatters: false));
        IsFalse(OneFirst          .IsNully (              false));
        IsFalse(OneFirst          .IsNully ( zeroMatters       ));
        IsFalse(OneFirst          .IsNully ( zeroMatters: true ));
        IsFalse(OneFirst          .IsNully (              true ));
        IsFalse(OneFirst_Nully    .IsNully (                   ));
        IsFalse(OneFirst_Nully    .IsNully ( zeroMatters: false));
        IsFalse(OneFirst_Nully    .IsNully (              false));
        IsFalse(OneFirst_Nully    .IsNully ( zeroMatters       ));
        IsFalse(OneFirst_Nully    .IsNully ( zeroMatters: true ));
        IsFalse(OneFirst_Nully    .IsNully (              true ));
        IsFalse(TwoLast           .IsNully (                   ));
        IsFalse(TwoLast           .IsNully ( zeroMatters: false));
        IsFalse(TwoLast           .IsNully (              false));
        IsFalse(TwoLast           .IsNully ( zeroMatters       ));
        IsFalse(TwoLast           .IsNully ( zeroMatters: true ));
        IsFalse(TwoLast           .IsNully (              true ));
        IsFalse(TwoLast_Nully     .IsNully (                   ));
        IsFalse(TwoLast_Nully     .IsNully ( zeroMatters: false));
        IsFalse(TwoLast_Nully     .IsNully (              false));
        IsFalse(TwoLast_Nully     .IsNully ( zeroMatters       ));
        IsFalse(TwoLast_Nully     .IsNully ( zeroMatters: true ));
        IsFalse(TwoLast_Nully     .IsNully (              true ));
    }

    [TestMethod]
    public void Test_Enum_IsNully_Static_ZeroMatters()
    {
        IsTrue (IsNully (With0_Null                            ));
        IsTrue (IsNully (With0_Null,         zeroMatters: false));
        IsTrue (IsNully (With0_Null,                      false));
        IsTrue (IsNully (With0_Null,         zeroMatters       ));
        IsTrue (IsNully (With0_Null,         zeroMatters: true ));
        IsTrue (IsNully (With0_Null,                      true ));
        IsTrue (IsNully (With0_Default                         ));
        IsTrue (IsNully (With0_Default,      zeroMatters: false));
        IsTrue (IsNully (With0_Default,                   false));
        IsFalse(IsNully (With0_Default,      zeroMatters       ));
        IsFalse(IsNully (With0_Default,      zeroMatters: true ));
        IsFalse(IsNully (With0_Default,                   true ));
        IsTrue (IsNully (With0_DefaultNully                    ));
        IsTrue (IsNully (With0_DefaultNully, zeroMatters: false));
        IsTrue (IsNully (With0_DefaultNully,              false));
        IsTrue (IsNully (With0_DefaultNully, zeroMatters       ));
        IsTrue (IsNully (With0_DefaultNully, zeroMatters: true ));
        IsTrue (IsNully (With0_DefaultNully,              true ));
        IsTrue (IsNully (ZeroFirst                             ));
        IsTrue (IsNully (ZeroFirst,          zeroMatters: false));
        IsTrue (IsNully (ZeroFirst,                       false));
        IsFalse(IsNully (ZeroFirst,          zeroMatters       ));
        IsFalse(IsNully (ZeroFirst,          zeroMatters: true ));
        IsFalse(IsNully (ZeroFirst,                       true ));
        IsTrue (IsNully (ZeroFirst_Nully                       ));
        IsTrue (IsNully (ZeroFirst_Nully,    zeroMatters: false));
        IsTrue (IsNully (ZeroFirst_Nully,                 false));
        IsFalse(IsNully (ZeroFirst_Nully,    zeroMatters       ));
        IsFalse(IsNully (ZeroFirst_Nully,    zeroMatters: true ));
        IsFalse(IsNully (ZeroFirst_Nully,                 true ));
        IsFalse(IsNully (OneLast                               ));
        IsFalse(IsNully (OneLast,            zeroMatters: false));
        IsFalse(IsNully (OneLast,                         false));
        IsFalse(IsNully (OneLast,            zeroMatters       ));
        IsFalse(IsNully (OneLast,            zeroMatters: true ));
        IsFalse(IsNully (OneLast,                         true ));
        IsFalse(IsNully (OneLast_Nully                         ));
        IsFalse(IsNully (OneLast_Nully,      zeroMatters: false));
        IsFalse(IsNully (OneLast_Nully,                   false));
        IsFalse(IsNully (OneLast_Nully,      zeroMatters       ));
        IsFalse(IsNully (OneLast_Nully,      zeroMatters: true ));
        IsFalse(IsNully (OneLast_Nully,                   true ));
        IsTrue (IsNully (No0_Null                              ));
        IsTrue (IsNully (No0_Null,           zeroMatters: false));
        IsTrue (IsNully (No0_Null,                        false));
        IsTrue (IsNully (No0_Null,           zeroMatters       ));
        IsTrue (IsNully (No0_Null,           zeroMatters: true ));
        IsTrue (IsNully (No0_Null,                        true ));
        IsTrue (IsNully (No0_Default                           ));
        IsTrue (IsNully (No0_Default,        zeroMatters: false));
        IsTrue (IsNully (No0_Default,                     false));
        IsFalse(IsNully (No0_Default,        zeroMatters       ));
        IsFalse(IsNully (No0_Default,        zeroMatters: true ));
        IsFalse(IsNully (No0_Default,                     true ));
        IsTrue (IsNully (No0_DefaultNully                      ));
        IsTrue (IsNully (No0_DefaultNully,   zeroMatters: false));
        IsTrue (IsNully (No0_DefaultNully,                false));
        IsTrue (IsNully (No0_DefaultNully,   zeroMatters       ));
        IsTrue (IsNully (No0_DefaultNully,   zeroMatters: true ));
        IsTrue (IsNully (No0_DefaultNully,                true ));
        IsFalse(IsNully (OneFirst                              ));
        IsFalse(IsNully (OneFirst,           zeroMatters: false));
        IsFalse(IsNully (OneFirst,                        false));
        IsFalse(IsNully (OneFirst,           zeroMatters       ));
        IsFalse(IsNully (OneFirst,           zeroMatters: true ));
        IsFalse(IsNully (OneFirst,                        true ));
        IsFalse(IsNully (OneFirst_Nully                        ));
        IsFalse(IsNully (OneFirst_Nully,     zeroMatters: false));
        IsFalse(IsNully (OneFirst_Nully,                  false));
        IsFalse(IsNully (OneFirst_Nully,     zeroMatters       ));
        IsFalse(IsNully (OneFirst_Nully,     zeroMatters: true ));
        IsFalse(IsNully (OneFirst_Nully,                  true ));
        IsFalse(IsNully (TwoLast                               ));
        IsFalse(IsNully (TwoLast,            zeroMatters: false));
        IsFalse(IsNully (TwoLast,                         false));
        IsFalse(IsNully (TwoLast,            zeroMatters       ));
        IsFalse(IsNully (TwoLast,            zeroMatters: true ));
        IsFalse(IsNully (TwoLast,                         true ));
        IsFalse(IsNully (TwoLast_Nully                         ));
        IsFalse(IsNully (TwoLast_Nully,      zeroMatters: false));
        IsFalse(IsNully (TwoLast_Nully,                   false));
        IsFalse(IsNully (TwoLast_Nully,      zeroMatters       ));
        IsFalse(IsNully (TwoLast_Nully,      zeroMatters: true ));
        IsFalse(IsNully (TwoLast_Nully,                   true ));
    }
