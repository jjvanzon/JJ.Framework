...
public static class TestRunner
{
    ...
    [NoTrim(TypeArray)]
    public static IResult RunTests(Type[] testClasses) => RunTests(testClasses, new VoidResult());
    ...
    public static IResult RunTests([Dyn(PublicMethods | DefaultCtor)] Type testClass) => RunTests(NotNull(testClass), new VoidResult());
