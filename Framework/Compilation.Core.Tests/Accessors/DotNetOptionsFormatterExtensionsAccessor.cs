...
internal static class DotNetOptionsFormatterExtensionsAccessor
{
    ...
    public static string Stringify      (this DotNetOptions opt)                      => (string)_accessor.Call(opt)!;
    public static string DebuggerDisplay(this DotNetOptions opt)                      => (string)_accessor.Call(opt)!;
    public static string Descriptor     (this DotNetOptions opt, int? maxPathChars = null) => (string)_accessor.Call(opt, maxPathChars)!;
}
