...
public class DotNetArgBuilderTests
{
    ...
    {
        var info = new DotNetArgsAccessor(build)  { Command = "build", Args = "--nologo" };
    ...
    {
        var info = new DotNetArgsAccessor(build) { Command = "build" };
    ...
    {
        var info = new DotNetArgsAccessor(rebuild) { Command = "build", IsRebuild = true };
    ...
    {
        var info = new DotNetArgsAccessor(msrebuild) { Command = "msbuild", IsRebuild = true };
    ...
    {
        var info = new DotNetArgsAccessor(msbuild) { Command = "msbuild" };
    ...
    {
        var info = new DotNetArgsAccessor(restore) { Command = "restore", IsRebuild = true };
    ...
    {
        var info = new DotNetArgsAccessor(installpackage) { Command = "add", ID = "Newtonsoft.Json", Ver = "13.0.3", Args = "--prerelease" };
    ...
    {
        var info = new DotNetArgsAccessor(installpackage) { Command = "add", ID = "Serilog", Ver = "", Args = "" };
    ...
    {
        var info = new DotNetArgsAccessor(installpackage) { Command = "add", ID = "", Ver = "1.2.3", Args = "" };
