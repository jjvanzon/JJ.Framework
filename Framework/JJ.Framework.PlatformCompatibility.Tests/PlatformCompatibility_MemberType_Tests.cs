...
namespace JJ.Framework.PlatformCompatibility.Tests
{
    ...
    public class PlatformCompatibility_MemberType_Tests
    {
        ...
        [TestMethod]
        public void MemberType_PlatformSafe_Test()
        {
        ...
        [TestMethod]
        public void PlatformHelper_MemberInfo_MemberType_PlatformSafe_Test()
        {
            Type            type            =            GetType       (                 );
            ...
            // TODO: Test literal values of both PlatformSafe and regular enums
            ...
            //Assert.AreEqual(MemberTypes_PlatformSafe.NestedType,  PlatformHelper.MemberInfo_MemberType_PlatformSafe(nestedType));
            //Assert.AreEqual(MemberTypes_PlatformSafe.Constructor, PlatformHelper.MemberInfo_MemberType_PlatformSafe(constructorInfo));
