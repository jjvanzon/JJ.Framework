...
namespace JJ.Framework.Resources.Tests
{
	...
	/// That ResourceFormatter might so happens to be structured like CommonResourceFormatter from JJ.Framework.Resources.
	/// That would mean, that each public static member of the ResourceFormatter class may return a string.
	/// That string may not be null or white space. The thread culture might change to different cultures to repeat the checks.
	...
	/// some other resource formatters the way JJ.Framework.Resources would do things.
	/// 
