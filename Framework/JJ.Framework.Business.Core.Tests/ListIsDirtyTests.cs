...
public class ListIsDirtyTests
{
    ...
    {
        var list1 = new List<Category> { new() { ID = 1, Name = "A" }, new() { ID = 2, Name = "B" } };
    ...
    {
        var list1 = new List<Category> { new() { ID = 1 } };
    ...
    {
        var list1 = new List<Category> { new() { ID = 1 }, new() { ID = 2 } };
    ...
    {
        var list = new List<Category> { new() { ID = 1 } };
        var listE = new List<Category> { new() { ID = 1 } };

        // list1 null
        Throws(() => GetListIsDirty<Category, Category>(null!, x => x.ID, listE, x => x.ID), "list1", "null");

        // getKey1 null
        Throws(() => GetListIsDirty<Category, Category>(list, null!, listE, x => x.ID), "getKey1", "null");

        // list2 null
        Throws(() => GetListIsDirty<Category, Category>(list, x => x.ID, null!, x => x.ID), "list2", "null");

        // getKey2 null
        Throws(() => GetListIsDirty<Category, Category>(list, x => x.ID, listE, null!), "getKey2", "null");
    }
}
