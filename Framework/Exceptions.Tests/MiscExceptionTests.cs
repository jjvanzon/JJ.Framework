...
namespace JJ.Framework.Exceptions.Tests
{
	...
	public class MiscExceptionTests
	{
		...
		[TestMethod]
		public void Test_IsNotTypeException_WithType()
		{
		...
		[TestMethod]
		public void Test_IsNotTypeException_WithTypeName()
		{
			AssertHelper.ThrowsException<IsNotTypeException>(
				() =>
				{
		...
		[TestMethod]
		public void Test_IsTypeException_WithType()
		{
		...
		[TestMethod]
		public void Test_IsTypeException_WithTypeName()
		{
			AssertHelper.ThrowsException<IsTypeException>(
				() =>
				{
