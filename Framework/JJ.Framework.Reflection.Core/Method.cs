...
public partial class Reflector
{
    ...
    private readonly Lock        _methodDictLockN = new();
        ...
        [TrimWarn(GetTypes)] public        MethodInfo  Method(                          string type,                                  [Caller] string name = ""        ) => MethodOrThrow    (type,      name,                   BindingFlags,                        _methodDict0, _methodDictLock0, _cache);
        ...
        [TrimWarn(GetTypes)] public        MethodInfo? Method(                          string type,              bool      nullable, [Caller] string name = ""        ) => MethodOrSomething(type,      name, nullable,         BindingFlags,                        _methodDict0, _methodDictLock0, _cache);
...
[Prio(1),TrimWarn(GetTypes)] public        MethodInfo? Method(                          string type,              NullFlag? nullable, [Caller] string name = ""        ) => MethodOrSomething(type,      name, nullable == null, BindingFlags,                        _methodDict0, _methodDictLock0, _cache);
...
[Prio(1)]                  public        MethodInfo? Method<[Dyn(AllMethods)] T>(                               NullFlag? nullable, [Caller] string name = ""        ) => MethodOrSomething(typeof(T), name, nullable == null, BindingFlags,                        _methodDict0, _methodDictLock0        );
        [TrimWarn(GetTypes)] public        MethodInfo? Method(                          string type, string name, bool      nullable                                   ) => MethodOrSomething(type,      name, nullable,         BindingFlags,                        _methodDict0, _methodDictLock0, _cache);
...
[Prio(1),TrimWarn(GetTypes)] public        MethodInfo? Method(                          string type, string name, NullFlag? nullable                                   ) => MethodOrSomething(type,      name, nullable == null, BindingFlags,                        _methodDict0, _methodDictLock0, _cache);
...
[Prio(1)]                  public        MethodInfo? Method<[Dyn(AllMethods)] T>(                  string name, NullFlag? nullable                                   ) => MethodOrSomething(typeof(T), name, nullable == null, BindingFlags,                        _methodDict0, _methodDictLock0        );
        [TrimWarn(GetTypes)] public        MethodInfo  Method(                          string type, string name,                     params Type?[] argTypes          ) => MethodOrThrow    (type,      name,                   BindingFlags,    argTypes,           _methodDictN, _methodDictLockN, _cache);
        ...
        [TrimWarn(GetTypes)] public        MethodInfo? Method(                          string type, string name, bool      nullable, params Type?[] argTypes          ) => MethodOrSomething(type,      name, nullable,         BindingFlags,    argTypes,           _methodDictN, _methodDictLockN, _cache);
...
[Prio(1),TrimWarn(GetTypes)] public        MethodInfo? Method(                          string type, string name, NullFlag? nullable, params Type?[] argTypes          ) => MethodOrSomething(type,      name, nullable == null, BindingFlags,    argTypes,           _methodDictN, _methodDictLockN, _cache);
...
[Prio(1)]                  public        MethodInfo? Method<[Dyn(AllMethods)] T>(                  string name, NullFlag? nullable, params Type?[] argTypes          ) => MethodOrSomething(typeof(T), name, nullable == null, BindingFlags,    argTypes,           _methodDictN, _methodDictLockN        );
        [TrimWarn(GetTypes)] public        MethodInfo  Method(                          string type, string name,                     Type?[] argTypes, Type[] typeArgs) => MethodOrThrow    (type,      name,                   BindingFlags,    argTypes, typeArgs, _methodDictN, _methodDictLockN, _cache);
        ...
        [TrimWarn(GetTypes)] public        MethodInfo? Method(                          string type, string name, bool      nullable, Type?[] argTypes, Type[] typeArgs) => MethodOrSomething(type,      name, nullable,         BindingFlags,    argTypes, typeArgs, _methodDictN, _methodDictLockN, _cache);
...
[Prio(1),TrimWarn(GetTypes)] public        MethodInfo? Method(                          string type, string name, NullFlag? nullable, Type?[] argTypes, Type[] typeArgs) => MethodOrSomething(type,      name, nullable == null, BindingFlags,    argTypes, typeArgs, _methodDictN, _methodDictLockN, _cache);
...
public static partial class Reflect
{
    ...
    internal static readonly Lock        _methodDictLockN = new();
        ...
        [TrimWarn(GetTypes)] public static MethodInfo  Method(                          string type,                                  [Caller] string name = ""        ) => MethodOrThrow    (type,      name,                   BindingFlagsAll,                     _methodDict0, _methodDictLock0, _cache);
        ...
        [TrimWarn(GetTypes)] public static MethodInfo? Method(                          string type,              bool      nullable, [Caller] string name = ""        ) => MethodOrSomething(type,      name, nullable,         BindingFlagsAll,                     _methodDict0, _methodDictLock0, _cache);
...
[Prio(1),TrimWarn(GetTypes)] public static MethodInfo? Method(                          string type,              NullFlag? nullable, [Caller] string name = ""        ) => MethodOrSomething(type,      name, nullable == null, BindingFlagsAll,                     _methodDict0, _methodDictLock0, _cache);
...
[Prio(1)]                  public static MethodInfo? Method<[Dyn(AllMethods)] T>(                               NullFlag? nullable, [Caller] string name = ""        ) => MethodOrSomething(typeof(T), name, nullable == null, BindingFlagsAll,                     _methodDict0, _methodDictLock0        );
        [TrimWarn(GetTypes)] public static MethodInfo? Method(                          string type, string name, bool      nullable                                   ) => MethodOrSomething(type,      name, nullable,         BindingFlagsAll,                     _methodDict0, _methodDictLock0, _cache);
...
[Prio(1),TrimWarn(GetTypes)] public static MethodInfo? Method(                          string type, string name, NullFlag? nullable                                   ) => MethodOrSomething(type,      name, nullable == null, BindingFlagsAll,                     _methodDict0, _methodDictLock0, _cache);
...
[Prio(1)]                  public static MethodInfo? Method<[Dyn(AllMethods)] T>(                  string name, NullFlag? nullable                                   ) => MethodOrSomething(typeof(T), name, nullable == null, BindingFlagsAll,                     _methodDict0, _methodDictLock0        );
        [TrimWarn(GetTypes)] public static MethodInfo  Method(                          string type, string name,                     params Type?[] argTypes          ) => MethodOrThrow    (type,      name,                   BindingFlagsAll, argTypes,           _methodDictN, _methodDictLockN, _cache);
        ...
        [TrimWarn(GetTypes)] public static MethodInfo? Method(                          string type, string name, bool      nullable, params Type?[] argTypes          ) => MethodOrSomething(type,      name, nullable,         BindingFlagsAll, argTypes,           _methodDictN, _methodDictLockN, _cache);
...
[Prio(1),TrimWarn(GetTypes)] public static MethodInfo? Method(                          string type, string name, NullFlag? nullable, params Type?[] argTypes          ) => MethodOrSomething(type,      name, nullable == null, BindingFlagsAll, argTypes,           _methodDictN, _methodDictLockN, _cache);
...
[Prio(1)]                  public static MethodInfo? Method<[Dyn(AllMethods)] T>(                  string name, NullFlag? nullable, params Type?[] argTypes          ) => MethodOrSomething(typeof(T), name, nullable == null, BindingFlagsAll, argTypes,           _methodDictN, _methodDictLockN        );
        [TrimWarn(GetTypes)] public static MethodInfo  Method(                          string type, string name,                     Type?[] argTypes, Type[] typeArgs) => MethodOrThrow    (type,      name,                   BindingFlagsAll, argTypes, typeArgs, _methodDictN, _methodDictLockN, _cache);
        ...
        [TrimWarn(GetTypes)] public static MethodInfo? Method(                          string type, string name, bool      nullable, Type?[] argTypes, Type[] typeArgs) => MethodOrSomething(type,      name, nullable,         BindingFlagsAll, argTypes, typeArgs, _methodDictN, _methodDictLockN, _cache);
...
[Prio(1),TrimWarn(GetTypes)] public static MethodInfo? Method(                          string type, string name, NullFlag? nullable, Type?[] argTypes, Type[] typeArgs) => MethodOrSomething(type,      name, nullable == null, BindingFlagsAll, argTypes, typeArgs, _methodDictN, _methodDictLockN, _cache);
...
{
        [TrimWarn(GetTypes)] public static MethodInfo  Method(                     this string type,                                  [Caller] string name = ""        ) => MethodOrThrow    (type,      name,                   BindingFlagsAll,                     _methodDict0, _methodDictLock0, _cache);
        ...
        [TrimWarn(GetTypes)] public static MethodInfo? Method(                     this string type,              bool      nullable, [Caller] string name = ""        ) => MethodOrSomething(type,      name, nullable,         BindingFlagsAll,                     _methodDict0, _methodDictLock0, _cache);
...
[Prio(1),TrimWarn(GetTypes)] public static MethodInfo? Method(                     this string type,              NullFlag? nullable, [Caller] string name = ""        ) => MethodOrSomething(type,      name, nullable == null, BindingFlagsAll,                     _methodDict0, _methodDictLock0, _cache);
...
//[Prio(1)]                public static MethodInfo? Method<[Dyn(AllMethods)] T>(this                           NullFlag? nullable, [Caller] string name = ""        ) => MethodOrSomething(typeof(T), name, nullable == null, BindingFlagsAll,                     _methodDict0, _methodDictLock0        );
        [TrimWarn(GetTypes)] public static MethodInfo? Method(                     this string type, string name, bool      nullable                                   ) => MethodOrSomething(type,      name, nullable,         BindingFlagsAll,                     _methodDict0, _methodDictLock0, _cache);
...
[Prio(1),TrimWarn(GetTypes)] public static MethodInfo? Method(                     this string type, string name, NullFlag? nullable                                   ) => MethodOrSomething(type,      name, nullable == null, BindingFlagsAll,                     _methodDict0, _methodDictLock0, _cache);
...
[Prio(1)]                  public static MethodInfo? Method<[Dyn(AllMethods)] T>(this              string name, NullFlag? nullable                                   ) => MethodOrSomething(typeof(T), name, nullable == null, BindingFlagsAll,                     _methodDict0, _methodDictLock0        );
        [TrimWarn(GetTypes)] public static MethodInfo  Method(                     this string type, string name,                     params Type?[] argTypes          ) => MethodOrThrow    (type,      name,                   BindingFlagsAll, argTypes,           _methodDictN, _methodDictLockN, _cache);
        ...
        [TrimWarn(GetTypes)] public static MethodInfo? Method(                     this string type, string name, bool      nullable, params Type?[] argTypes          ) => MethodOrSomething(type,      name, nullable,         BindingFlagsAll, argTypes,           _methodDictN, _methodDictLockN, _cache);
...
[Prio(1),TrimWarn(GetTypes)] public static MethodInfo? Method(                     this string type, string name, NullFlag? nullable, params Type?[] argTypes          ) => MethodOrSomething(type,      name, nullable == null, BindingFlagsAll, argTypes,           _methodDictN, _methodDictLockN, _cache);
...
[Prio(1)]                  public static MethodInfo? Method<[Dyn(AllMethods)] T>(this              string name, NullFlag? nullable, params Type?[] argTypes          ) => MethodOrSomething(typeof(T), name, nullable == null, BindingFlagsAll, argTypes,           _methodDictN, _methodDictLockN        );
        [TrimWarn(GetTypes)] public static MethodInfo  Method(                     this string type, string name,                     Type?[] argTypes, Type[] typeArgs) => MethodOrThrow    (type,      name,                   BindingFlagsAll, argTypes, typeArgs, _methodDictN, _methodDictLockN, _cache);
        ...
        [TrimWarn(GetTypes)] public static MethodInfo? Method(                     this string type, string name, bool      nullable, Type?[] argTypes, Type[] typeArgs) => MethodOrSomething(type,      name, nullable,         BindingFlagsAll, argTypes, typeArgs, _methodDictN, _methodDictLockN, _cache);
...
[Prio(1),TrimWarn(GetTypes)] public static MethodInfo? Method(                     this string type, string name, NullFlag? nullable, Type?[] argTypes, Type[] typeArgs) => MethodOrSomething(type,      name, nullable == null, BindingFlagsAll, argTypes, typeArgs, _methodDictN, _methodDictLockN, _cache);
