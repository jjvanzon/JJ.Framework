...
public static partial class Reflect
{
    ...
    internal static readonly Lock _propDicLock = new();
...
public static partial class ReflectExtensions
{
    ...
    public static PropertyInfo  Prop   (this Type type,            [Caller] string name = ""                                ) => PropOrThrow    (type,          name,           BindingFlagsAll, _propDic, _propDicLock        );
    public static PropertyInfo  Prop   (this string shortTypeName, [Caller] string name = ""                                ) => PropOrThrow    (shortTypeName, name,           BindingFlagsAll, _propDic, _propDicLock, _cache);
    public static PropertyInfo  Prop<T>(this T obj,                [Caller] string name = ""                                ) => PropOrThrow    (typeof(T),     name,           BindingFlagsAll, _propDic, _propDicLock        );
    ...
    public static PropertyInfo? Prop   (this Type type,                     string name,           NullableFlag nullable    ) => PropOrNull     (type,          name,           BindingFlagsAll, _propDic, _propDicLock        );
    public static PropertyInfo? Prop   (this string shortTypeName,          string name,           NullableFlag nullable    ) => PropOrNull     (shortTypeName, name,           BindingFlagsAll, _propDic, _propDicLock, _cache);
    public static PropertyInfo? Prop<T>(this T obj,                         string name,           NullableFlag nullable    ) => PropOrNull     (typeof(T),     name,           BindingFlagsAll, _propDic, _propDicLock        );
    //public static PropertyInfo? Prop<T>(this                              string name,           bool         nullable    ) => PropOrSomething(typeof(T),     name, nullable, BindingFlagsAll, _propDic, _propDicLock        );
    public static PropertyInfo? Prop   (this Type type,                     string name,           bool         nullable    ) => PropOrSomething(type,          name, nullable, BindingFlagsAll, _propDic, _propDicLock        );
    public static PropertyInfo? Prop   (this string shortTypeName,          string name,           bool         nullable    ) => PropOrSomething(shortTypeName, name, nullable, BindingFlagsAll, _propDic, _propDicLock, _cache);
    public static PropertyInfo? Prop<T>(this T obj,                         string name,           bool         nullable    ) => PropOrSomething(typeof(T),     name, nullable, BindingFlagsAll, _propDic, _propDicLock        );
    //public static PropertyInfo? Prop<T>(this                              NullableFlag nullable, [Caller] string name = "") => PropOrNull     (typeof(T),     name,           BindingFlagsAll, _propDic, _propDicLock        );
    public static PropertyInfo? Prop   (this Type type,                     NullableFlag nullable, [Caller] string name = "") => PropOrNull     (type,          name,           BindingFlagsAll, _propDic, _propDicLock        );
    public static PropertyInfo? Prop   (this string shortTypeName,          NullableFlag nullable, [Caller] string name = "") => PropOrNull     (shortTypeName, name,           BindingFlagsAll, _propDic, _propDicLock, _cache);
    public static PropertyInfo? Prop<T>(this T obj,                         NullableFlag nullable, [Caller] string name = "") => PropOrNull     (typeof(T),     name,           BindingFlagsAll, _propDic, _propDicLock        );
    //public static PropertyInfo? Prop<T>(this                              bool         nullable, [Caller] string name = "") => PropOrSomething(typeof(T),     name, nullable, BindingFlagsAll, _propDic, _propDicLock        );
    public static PropertyInfo? Prop   (this Type type,                     bool         nullable, [Caller] string name = "") => PropOrSomething(type,          name, nullable, BindingFlagsAll, _propDic, _propDicLock        );
    public static PropertyInfo? Prop   (this string shortTypeName,          bool         nullable, [Caller] string name = "") => PropOrSomething(shortTypeName, name, nullable, BindingFlagsAll, _propDic, _propDicLock, _cache);
    public static PropertyInfo? Prop<T>(this T obj,                         bool         nullable, [Caller] string name = "") => PropOrSomething(typeof(T),     name, nullable, BindingFlagsAll, _propDic, _propDicLock        );
}
