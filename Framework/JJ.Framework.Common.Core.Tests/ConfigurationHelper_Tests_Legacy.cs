...
using ConfigurationSection = JJ.Framework.Common.Core.Tests.ConfigurationSectionLegacy;
using ConfigurationSection2 = JJ.Framework.Common.Core.Tests.ConfigurationSectionLegacy2;
using ConfigurationSection3 = JJ.Framework.Common.Core.Tests.ConfigurationSectionLegacy3;
using ConfigurationHelper_Accessor = JJ.Framework.Common.Core.Tests.ConfigurationHelper_Accessor_Legacy;
...
{
    [TestClass]
    public class ConfigurationHelper_Tests_Legacy
    {
        ...
        public void Test_ConfigurationHelper_ComplexExample()
        {
            lock (_lock)
            {
                try
                {
                    ...
                    //var output_ConfigSection_ByWhiteSpaceName = ConfigurationHelperCore.TryGetSection<ConfigurationSection>(" ");
        ...
        public void Test_ConfigurationHelper_AutoGeneratedNames_DifferentAssembly_DifferentName()
        {
            lock (_lock)
            {
                try
                {
                    ...
                    AssertHelper.NotEqual(outputConfigSection1_NameOmitted, () => outputConfigSection2_NameOmitted);
                }
                finally
                {
                    // Clean Up
        ...
        public void Test_ConfigurationHelper_SetSection_TryGetSection_Succeeds_SectionNameOmitted()
        {
            lock (_lock)
            {
                try
                {
                    ...
                    // Act
                    ConfigurationHelper.SetSection(inputConfigSection);
                    var outputConfigSection = ConfigurationHelperCore.TryGetSection<ConfigurationSection>();
        ...
        public void Test_ConfigurationHelper_GetSection_SectionNotFound_ThrowsException_SectionNameOmitted()
        {
            lock (_lock)
            {
                AssertHelper.ThrowsException(
                    ...
                    "Configuration section of type 'JJ.Framework.Common.Core.Tests.ConfigurationSectionLegacy' was not set. " +
        ...
        public void Test_ConfigurationHelper_TryGetSection_SectionNotFound_ReturnsNull_SectionNameOmitted()
        {
            lock (_lock)
            {
                var configSection = ConfigurationHelperCore.TryGetSection<ConfigurationSection>();
        ...
        public void Test_ConfigurationHelper_EdgeCase_SetSection_AlreadyCalled_ThrowsException()
        {
            lock (_lock)
            {
                try
                {
                    ...
                    AssertHelper.ThrowsException(
                        () => ConfigurationHelper.SetSection(inputConfigSection),
                        "Configuration section of type 'JJ.Framework.Common.Core.Tests.ConfigurationSectionLegacy' was already set.");
                }
                finally
                {
                    // Clean Up
