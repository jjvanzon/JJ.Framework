...
public class ContainsTests
{
    ...
    [TestMethod]
    public void Test_Contains_CaseMattersNo_Implicit()
    {
       string[] coll = [ "Red", "Green", "Blue" ];
    ...
    [TestMethod]
    public void Test_Contains_CaseMattersNo_ExplicitNamedFlagInBack()
    {
       string[] coll = [ "Red", "Green", "Blue" ];
    ...
    [TestMethod]
    public void Test_Contains_CaseMattersNo_ExplicitNamedFlagInFront()
    {
       string[] coll = [ "Red", "Green", "Blue" ];
    ...
    [TestMethod]
    public void Test_Contains_CaseMattersNo_ExplicitUnnamedFlagInBack()
    {
       string[] coll = [ "Red", "Green", "Blue" ];
    ...
    [TestMethod]
    public void Test_Contains_CaseMattersNo_ExplicitUnnamedFlagInFront()
    {
       string[] coll = [ "Red", "Green", "Blue" ];
    ...
    [TestMethod]
    public void Test_Contains_CaseMattersYes_MagicBoolFlagInBack()
    {
       string[] coll = [ "Red", "Green", "Blue" ];
    ...
    [TestMethod]
    public void Test_Contains_CaseMattersYes_MagicBoolFlagInFront()
    {
       string[] coll = [ "Red", "Green", "Blue" ];
    ...
    [TestMethod]
    public void Test_Contains_CaseMattersYes_ExplicitBoolNamedBoolFlagInBack()
    {
       string[] coll = [ "Red", "Green", "Blue" ];
    ...
    [TestMethod]
    public void Test_Contains_CaseMattersYes_ExplicitNamedBoolFlagInFront()
    {
       string[] coll = [ "Red", "Green", "Blue" ];
    ...
    [TestMethod]
    public void Test_Contains_CaseMattersYes_ExplicitBoolUnnamedBoolFlagInBack()
    {
       string[] coll = [ "Red", "Green", "Blue" ];
    ...
    [TestMethod]
    public void Test_Contains_CaseMattersYes_ExplicitUnnamedBoolFlagInFront()
    {
       string[] coll = [ "Red", "Green", "Blue" ];
    ...
    [TestMethod]
    public void Test_Contains_NullableItem()
    {
