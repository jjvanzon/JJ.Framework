...
public class Coalesce_3Args_Bool_ExtensionsZeroMattersFlagsInBack : TestBase
{
    ...
    public void Coalesce_3Args_Bool_ExtensionsZeroMattersFlagsInBack_Batch1()
    {
        ...
        NoNullRet(false, NullBool  .Coalesce(NullyFalse, NullBool,                true ));
        ...
        NoNullRet(false, NullBool  .Coalesce(NullyFalse, NullyTrue,               true ));
        ...
        NoNullRet(false, NullBool  .Coalesce(NullyFalse, False,                   true ));
        ...
        NoNullRet(false, NullBool  .Coalesce(NullyFalse, True,                    true ));
      ...
      //NoNullRet(false, NullBool  .Coalesce(False,      NullyFalse,              true )); // TODO: Fails
      ...
      //NoNullRet(false, NullBool  .Coalesce(False,      NullBool,                true )); // TODO: Fails
      ...
      //NoNullRet(false, NullBool  .Coalesce(False,      NullyTrue,               true )); // TODO: Fails
      ...
      //NoNullRet(false, NullBool  .Coalesce(False,      True,                    true )); // TODO: Fails
    ...
    public void Coalesce_3Args_Bool_ExtensionsZeroMattersFlagsInBack_Batch2()
    {
        ...
        NoNullRet(false, NullyFalse.Coalesce(NullBool,   NullyFalse,              true ));
        ...
        NoNullRet(false, NullyFalse.Coalesce(NullBool,   NullyTrue,               true ));
        ...
        NoNullRet(false, NullyFalse.Coalesce(NullBool,   False,                   true ));
        ...
        NoNullRet(false, NullyFalse.Coalesce(NullBool,   True,                    true ));
        ...
        NoNullRet(false, NullyFalse.Coalesce(NullyTrue,  NullBool,                true ));
        ...
        NoNullRet(false, NullyFalse.Coalesce(NullyTrue,  NullyFalse,              true ));
        ...
        NoNullRet(false, NullyFalse.Coalesce(NullyTrue,  False,                   true ));
        ...
        NoNullRet(false, NullyFalse.Coalesce(NullyTrue,  True,                    true ));
      ...
      //NoNullRet(false, NullyFalse.Coalesce(False,      NullBool,                true )); // TODO: Fails
      ...
      //NoNullRet(false, NullyFalse.Coalesce(False,      NullyFalse,              true )); // TODO: Fails
      ...
      //NoNullRet(false, NullyFalse.Coalesce(False,      NullyTrue,               true )); // TODO: Fails
      ...
      //NoNullRet(false, NullyFalse.Coalesce(False,      True,                    true )); // TODO: Fails
      ...
      //NoNullRet(true,  NullyFalse.Coalesce(True,       NullyFalse,              false)); // TODO: Fails
        ...
        NoNullRet(false, NullyFalse.Coalesce(True,       NullyFalse,              true ));
    ...
    public void Coalesce_3Args_Bool_ExtensionsZeroMattersFlagsInBack_Batch4()
    {
        ...
        NoNullRet(false, False     .Coalesce(NullBool,   NullyFalse,              true ));
        ...
        NoNullRet(false, False     .Coalesce(NullBool,   NullyTrue,               true ));
        ...
        NoNullRet(false, False     .Coalesce(NullBool,   False,                   true ));
        ...
        NoNullRet(false, False     .Coalesce(NullBool,   True,                    true ));
        ...
        NoNullRet(false, False     .Coalesce(NullyFalse, NullBool,                true ));
        ...
        NoNullRet(false, False     .Coalesce(NullyFalse, NullyTrue,               true ));
        ...
        NoNullRet(false, False     .Coalesce(NullyFalse, False,                   true ));
        ...
        NoNullRet(false, False     .Coalesce(NullyFalse, True,                    true ));
        ...
        NoNullRet(false, False     .Coalesce(NullyTrue,  NullBool,                true ));
        ...
        NoNullRet(false, False     .Coalesce(NullyTrue,  NullyFalse,              true ));
        ...
        NoNullRet(false, False     .Coalesce(NullyTrue,  False,                   true ));
        ...
        NoNullRet(false, False     .Coalesce(NullyTrue,  True,                    true ));
      ...
      //NoNullRet(true,  False     .Coalesce(True,       False,                   false)); // TODO: Fails
        ...
        NoNullRet(false, False     .Coalesce(True,       False,                   true ));
    }
