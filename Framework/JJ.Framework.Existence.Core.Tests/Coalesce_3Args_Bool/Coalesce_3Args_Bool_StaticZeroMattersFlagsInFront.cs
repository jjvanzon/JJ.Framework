...
public class Coalesce_3Args_Bool_StaticZeroMattersFlagsInFront : TestBase
{
    ...
    public void Coalesce_3Args_Bool_StaticZeroMattersFlagsInFront_Batch1()
    {
        ...
        NoNullRet(false, Coalesce(             true,  NullBool,   NullyFalse, NullBool  ));
        ...
        NoNullRet(false, Coalesce(             true,  NullBool,   NullyFalse, NullyTrue ));
      ...
      //NoNullRet(false, Coalesce(             true,  NullBool,   NullyFalse, False     )); // TODO: Does not work
        
        NoNullRet(true,  Coalesce(                    NullBool,   NullyFalse, True      ));
        NoNullRet(true,  Coalesce(zeroMatters: false, NullBool,   NullyFalse, True      ));
      //NoNullRet(true,  Coalesce(             false, NullBool,   NullyFalse, True      )); // TODO: Does not work
      ...
      //NoNullRet(false, Coalesce(             true,  NullBool,   NullyFalse, True      )); // TODO: Does not work
      ...
      //NoNullRet(true,  Coalesce(             false, NullBool,   NullyTrue,  True      )); // TODO: Does not work
      ...
      //NoNullRet(true,  Coalesce(             true,  NullBool,   NullyTrue,  True      )); // TODO: Does not work
        ...
        NoNullRet(false, Coalesce(             true,  NullBool,   False,      NullyFalse));
        ...
        NoNullRet(false, Coalesce(             true,  NullBool,   False,      NullBool  ));
    ...
    public void Coalesce_3Args_Bool_StaticZeroMattersFlagsInFront_Batch2()
    {
        ...
        NoNullRet(false, Coalesce(             true,  NullyFalse, NullBool,   NullyFalse));
        ...
        NoNullRet(false, Coalesce(             true,  NullyFalse, NullBool,   NullyTrue ));
      ...
      //NoNullRet(false, Coalesce(             true,  NullyFalse, NullBool,   False     )); // TODO: Does not work
        
        NoNullRet(true,  Coalesce(                    NullyFalse, NullBool,   True      ));
        NoNullRet(true,  Coalesce(zeroMatters: false, NullyFalse, NullBool,   True      ));
      //NoNullRet(true,  Coalesce(             false, NullyFalse, NullBool,   True      )); // TODO: Does not work
      ...
      //NoNullRet(false, Coalesce(             true,  NullyFalse, NullBool,   True      )); // TODO: Does not work
        ...
        NoNullRet(false, Coalesce(             true,  NullyFalse, NullyTrue,  NullBool  ));
        ...
        NoNullRet(false, Coalesce(             true,  NullyFalse, NullyTrue,  NullyFalse));
      ...
      //NoNullRet(false, Coalesce(             true,  NullyFalse, NullyTrue,  False     )); // TODO: Does not work
        
        NoNullRet(true,  Coalesce(                    NullyFalse, NullyTrue,  True      ));
        NoNullRet(true,  Coalesce(zeroMatters: false, NullyFalse, NullyTrue,  True      ));
      //NoNullRet(true,  Coalesce(             false, NullyFalse, NullyTrue,  True      )); // TODO: Does not work
      ...
      //NoNullRet(false, Coalesce(             true,  NullyFalse, NullyTrue,  True      )); // TODO: Does not work
        ...
        NoNullRet(false, Coalesce(             true,  NullyFalse, False,      NullBool  ));
        ...
        NoNullRet(false, Coalesce(             true,  NullyFalse, False,      NullyFalse));
        ...
        NoNullRet(false, Coalesce(             true,  NullyFalse, False,      NullyTrue ));
        
        NoNullRet(true,  Coalesce(                    NullyFalse, False,      True      ));
        NoNullRet(true,  Coalesce(zeroMatters: false, NullyFalse, False,      True      ));
      //NoNullRet(true,  Coalesce(             false, NullyFalse, False,      True      )); // TODO: Does not work
      ...
      //NoNullRet(false, Coalesce(             true,  NullyFalse, False,      True      )); // TODO: Does not work
        ...
        NoNullRet(false, Coalesce(             true,  NullyFalse, True,       NullBool  ));
        ...
        NoNullRet(false, Coalesce(             true,  NullyFalse, True,       NullyFalse));
        ...
        NoNullRet(false, Coalesce(             true,  NullyFalse, True,       NullyTrue ));
      ...
      //NoNullRet(false, Coalesce(             true,  NullyFalse, True,       False     )); // TODO: Does not work
    }
    ...
    public void Coalesce_3Args_Bool_StaticZeroMattersFlagsInFront_Batch3()
    {
      ...
      //NoNullRet(true,  Coalesce(             false, NullyTrue,  NullBool,   True      )); // TODO: Does not work
      ...
      //NoNullRet(true,  Coalesce(             false, NullyTrue,  NullyFalse, True      )); // TODO: Does not work
      ...
      //NoNullRet(true,  Coalesce(             false, NullyTrue,  False,      True      )); // TODO: Does not work
    ...
    public void Coalesce_3Args_Bool_StaticZeroMattersFlagsInFront_Batch4()
    {
        ...
        NoNullRet(false, Coalesce(             true,  False,      NullBool,   NullyFalse));
      ...
      //NoNullRet(false, Coalesce(             true,  False,      NullBool,   True      )); // TODO: Does not work
        ...
        NoNullRet(false, Coalesce(             true,  False,      NullyFalse, NullBool  ));
        ...
        NoNullRet(false, Coalesce(             true,  False,      NullyFalse, NullyTrue ));
                
        NoNullRet(false, Coalesce(                    False,      NullyFalse, False     ));
        NoNullRet(false, Coalesce(zeroMatters: false, False,      NullyFalse, False     ));
      //NoNullRet(false, Coalesce(             false, False,      NullyFalse, False     )); // TODO: Does not work
      ...
      //NoNullRet(false, Coalesce(             true,  False,      NullyFalse, False     )); // TODO: Does not work

        NoNullRet(true,  Coalesce(                    False,      NullyFalse, True      ));
        NoNullRet(true,  Coalesce(zeroMatters: false, False,      NullyFalse, True      ));
      //NoNullRet(true,  Coalesce(             false, False,      NullyFalse, True      )); // TODO: Does not work
      ...
      //NoNullRet(false, Coalesce(             true,  False,      NullyFalse, True      )); // TODO: Does not work
        ...
        NoNullRet(false, Coalesce(             true,  False,      NullyTrue,  NullBool  ));
        ...
        NoNullRet(false, Coalesce(             true,  False,      NullyTrue,  NullyFalse));
                
        NoNullRet(true,  Coalesce(                    False,      NullyTrue,  False     ));
        NoNullRet(true,  Coalesce(zeroMatters: false, False,      NullyTrue,  False     ));
      //NoNullRet(true,  Coalesce(             false, False,      NullyTrue,  False     )); // TODO: Does not work
      ...
      //NoNullRet(false, Coalesce(             true,  False,      NullyTrue,  True      )); // TODO: Does not work
        ...
        NoNullRet(false, Coalesce(             true,  False,      True,       NullBool  ));
        ...
        NoNullRet(false, Coalesce(             true,  False,      True,       NullyFalse));
    ...
    public void Coalesce_3Args_Bool_StaticZeroMattersFlagsInFront_Batch5()
    {
      ...
      //NoNullRet(true,  Coalesce(             false, True,       False,      True      )); // TODO: Does not work
        NoNullRet(true,  Coalesce(zeroMatters,        True,       False,      True      ));
        NoNullRet(true,  Coalesce(zeroMatters: true,  True,       False,      True      ));
      //NoNullRet(true,  Coalesce(             true,  True,       False,      True      )); // TODO: Does not work
   }
}