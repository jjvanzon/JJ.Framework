...
Throws(() => NoNullRet(false, NullBool  .Coalesce(             true,  NullyFalse, NullBool  )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullBool  .Coalesce(             true,  NullyFalse, NullyTrue )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullBool  .Coalesce(             true,  NullyFalse, False     )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullBool  .Coalesce(             true,  NullyFalse, True      )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullBool  .Coalesce(             true,  False,      NullyFalse)), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullBool  .Coalesce(             true,  False,      NullBool  )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullBool  .Coalesce(             true,  False,      NullyTrue )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullBool  .Coalesce(             true,  False,      True      )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(             true,  NullBool,   NullyFalse)), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(             true,  NullBool,   NullyTrue )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(             true,  NullBool,   False     )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(             true,  NullyTrue,  NullBool  )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(             true,  NullyTrue,  NullyFalse)), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(             true,  NullyTrue,  False     )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(             true,  False,      NullBool  )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(             true,  False,      NullyFalse)), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(             true,  False,      NullyTrue )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(             true,  True,       NullBool  )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(             true,  True,       NullyFalse)), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(             true,  True,       NullyTrue )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(             true,  True,       False     )), "Actual <True>"); // Not a flag
    }
...
Throws(() => NoNullRet(false, False     .Coalesce(             true,  NullBool,   NullyFalse)), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, False     .Coalesce(             true,  NullBool,   NullyTrue )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, False     .Coalesce(             true,  NullBool,   False     )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, False     .Coalesce(             true,  NullyFalse, NullBool  )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, False     .Coalesce(             true,  NullyFalse, NullyTrue )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, False     .Coalesce(             true,  NullyFalse, False     )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, False     .Coalesce(             true,  NullyTrue,  NullBool  )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, False     .Coalesce(             true,  NullyTrue,  NullyFalse)), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, False     .Coalesce(             true,  NullyTrue,  False     )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, False     .Coalesce(             true,  True,       NullBool  )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, False     .Coalesce(             true,  True,       NullyFalse)), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, False     .Coalesce(             true,  True,       NullyTrue )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, False     .Coalesce(             true,  True,       False     )), "Actual <True>"); // Not a flag
    }
