...
public class Coalesce_3Args_ObjectsToText : TestBase
{
    ...
    public void Coalesce_3Args_ObjectsToString_Static()
    {
        ...
        NoNullRet(Text,             Coalesce(Null,        Null,        NullyFilledText));
        ...
        NoNullRet($"{Obj}",         Coalesce(Null,        Obj,         NullyFilledText));
        ...
        NoNullRet($"{NullyFilled}", Coalesce(Null,        NullyFilled, NullyFilledText));
        ...
        NoNullRet($"{Obj}",         Coalesce(Obj,         Null,        NullyFilledText));
        ...
        NoNullRet($"{Obj}",         Coalesce(Obj,         Obj,         NullyFilledText));
        ...
        NoNullRet($"{Obj}",         Coalesce(Obj,         NullyFilled, NullyFilledText));
        ...
        NoNullRet($"{NullyFilled}", Coalesce(NullyFilled, Null,        NullyFilledText));
        ...
        NoNullRet($"{NullyFilled}", Coalesce(NullyFilled, Obj,         NullyFilledText));
        ...
        NoNullRet($"{NullyFilled}", Coalesce(NullyFilled, NullyFilled, NullyFilledText));
    }
    ...
    public void Coalesce_3Args_ObjectsToString_Extensions()
    {
        ...
        NoNullRet(Text,             Null       .Coalesce( Null,        NullyFilledText));
        ...
        NoNullRet($"{Obj}",         Null       .Coalesce( Obj,         NullyFilledText));
        ...
        NoNullRet($"{NullyFilled}", Null       .Coalesce( NullyFilled, NullyFilledText));
        ...
        NoNullRet($"{Obj}",         Obj        .Coalesce( Null,        NullyFilledText));
        ...
        NoNullRet($"{Obj}",         Obj        .Coalesce( Obj,         NullyFilledText));
        ...
        NoNullRet($"{Obj}",         Obj        .Coalesce( NullyFilled, NullyFilledText));
        ...
        NoNullRet($"{NullyFilled}", NullyFilled.Coalesce( Null,        NullyFilledText));
        ...
        NoNullRet($"{NullyFilled}", NullyFilled.Coalesce( Obj,         NullyFilledText));
        ...
        NoNullRet($"{NullyFilled}", NullyFilled.Coalesce( NullyFilled, NullyFilledText));
    }
}