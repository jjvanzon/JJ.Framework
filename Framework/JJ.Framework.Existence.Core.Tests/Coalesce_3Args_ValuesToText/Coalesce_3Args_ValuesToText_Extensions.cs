...
[TestClass]
public class Coalesce_3Args_ValuesToText_Extensions : TestBase
{
    [TestMethod]
    public void Coalesce_3Args_ValuesToText_Extensions_Batch1()
    {
    ...
    [TestMethod]
    public void Coalesce_3Args_ValuesToText_Extensions_Batch2()
    {
    ...
    [TestMethod]
    public void Coalesce_3Args_ValuesToText_Extensions_Batch3()
    {
    ...
    [TestMethod]
    public void Coalesce_3Args_ValuesToText_Extensions_Batch4()
    {
    ...
    [TestMethod]
    public void Coalesce_3Args_ValuesToText_Extensions_Batch5()
    {
