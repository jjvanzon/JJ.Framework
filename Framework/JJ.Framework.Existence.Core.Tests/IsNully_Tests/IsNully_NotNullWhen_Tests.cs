...
public class IsNully_NotNullWhen_Tests : TestBase
{
    ...
    [TestMethod]
    public void IsNully_NotNullWhen_Text()
    {
    ...
    /// <inheritdoc cref="_notnullwhentests" />
    [TestMethod]
    public void IsNully_NotNullWhen_StringBuilder()
    {
    ...
    /// <inheritdoc cref="_notnullwhentests" />
    [TestMethod]
    public void IsNully_NotNullWhen_Bool()
    {
        bool? Bool() => NullyTrue;
    ...
    /// <inheritdoc cref="_notnullwhentests" />
    [TestMethod]
    public void IsNully_NotNullWhen_Value()
    {
        int? Num() => Nully1;
