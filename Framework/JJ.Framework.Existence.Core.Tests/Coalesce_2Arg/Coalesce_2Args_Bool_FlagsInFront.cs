...
Throws(() => NoNullRet(false, Coalesce(             true,  NullyFalse, NullBool  )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, Coalesce(             true,  False,      NullBool  )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, Coalesce(             true,  NullBool,   NullyFalse)), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, Coalesce(             true,  False,      NullyFalse)), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, Coalesce(             true,  NullyFalse, NullyTrue )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, Coalesce(             true,  False,      NullyTrue )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, Coalesce(             true,  NullBool,   False     )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, Coalesce(             true,  NullyFalse, False     )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, Coalesce(             true,  NullyFalse, True      )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, Coalesce(             true,  False,      True      )), "Actual <True>"); // Not a flag
    }
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(             true,  NullBool  )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, False     .Coalesce(             true,  NullBool  )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullBool  .Coalesce(             true,  NullyFalse)), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, False     .Coalesce(             true,  NullyFalse)), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(             true,  NullyTrue )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, False     .Coalesce(             true,  NullyTrue )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullBool  .Coalesce(             true,  False     )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(             true,  False     )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, NullyFalse.Coalesce(             true,  True      )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet(false, False     .Coalesce(             true,  True      )), "Actual <True>"); // Not a flag
    }
...
Throws(() => NoNullRet("False",               Coalesce(             true,  False,      NullText )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet("False",               Coalesce(             true,  False,     "peekaboo")), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet("False",    False     .Coalesce(             true,              NullText )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet("False",    False     .Coalesce(             true,             "peekaboo")), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet("",                    Coalesce(             true,  NullBool,    NullText)), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet("boo",                 Coalesce(             true,  NullBool,   "boo"    )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet("False",               Coalesce(             true,  NullyFalse,  NullText)), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet("False",               Coalesce(             true,  NullyFalse, "boo"    )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet("",         NullBool  .Coalesce(             true,               NullText)), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet("boo",      NullBool  .Coalesce(             true,              "boo"    )), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet("False",    NullyFalse.Coalesce(             true,               NullText)), "Actual <True>"); // Not a flag
...
Throws(() => NoNullRet("False",    NullyFalse.Coalesce(             true,              "boo"    )), "Actual <True>"); // Not a flag
