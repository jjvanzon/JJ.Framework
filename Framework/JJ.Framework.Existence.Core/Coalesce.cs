...
{ 
    ...
    public static T      Coalesce<T>(     T?      val,  T       fallback) where T : struct       => HasValNully(val) ? val.Value : CoalesceVal     (fallback);
    public static T      Coalesce<T>(     T       val,  T?      fallback) where T : struct       => HasVal     (val) ? val       : CoalesceValNully(fallback);
    public static T      Coalesce<T>(     T       val,  T       fallback) where T : struct       => HasVal     (val) ? val       : CoalesceVal     (fallback);
...
{ 
    ...
    public static T      Coalesce<T>(this T?      val,  T?      fallback) where T : struct       => HasValNully(val) ? val.Value : CoalesceValNully(fallback);
    public static T      Coalesce<T>(this T?      val,  T       fallback) where T : struct       => HasValNully(val) ? val.Value : CoalesceVal     (fallback);
    public static T      Coalesce<T>(this T       val,  T?      fallback) where T : struct       => HasVal     (val) ? val       : CoalesceValNully(fallback);
    public static T      Coalesce<T>(this T       val,  T       fallback) where T : struct       => HasVal     (val) ? val       : CoalesceVal     (fallback);
