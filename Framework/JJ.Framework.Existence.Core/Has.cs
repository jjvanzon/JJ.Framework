...
internal static partial class ExistenceUtility
{
    ...
    public static bool HasEnumerable_NonGeneric([NotNullWhen(true)] NonGeneric.IEnumerable   ? coll)                   => coll?.AsEnumerable().Any() ?? false;
...
public static partial class FilledInHelper
{
  ...
  //public static bool FilledIn<T,U>  ([NotNullWhen(true )]      Dictionary<T,U>.ValueCollection.Enumerator            ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T>    ([NotNullWhen(true )]      HashSet<T>.AlternateLookup<TAlternate>                ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T>    ([NotNullWhen(true )]      HashSet<T>.Enumerator                                 ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T>    ([NotNullWhen(true )]      LinkedList<T>.Enumerator                              ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T>    ([NotNullWhen(true )]      List<T>.Enumerator                                    ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T,U>  ([NotNullWhen(true )]      OrderedDictionary<T,U>.Enumerator                     ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T,U>  ([NotNullWhen(true )]      OrderedDictionary<T,U>.KeyCollection.Enumerator       ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T,U>  ([NotNullWhen(true )]      OrderedDictionary<T,U>.ValueCollection.Enumerator     ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T,U>  ([NotNullWhen(true )]      PriorityQueue<T,U>.UnorderedItemsCollection.Enumerator? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T>    ([NotNullWhen(true )]      Queue<T>.Enumerator                                   ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T,U>  ([NotNullWhen(true )]      SortedDictionary<T,U>.Enumerator                      ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T,U>  ([NotNullWhen(true )]      SortedDictionary<T,U>.KeyCollection.Enumerator        ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T,U>  ([NotNullWhen(true )]      SortedDictionary<T,U>.ValueCollection.Enumerator      ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T>    ([NotNullWhen(true )]      SortedSet<T>.Enumerator                               ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T>    ([NotNullWhen(true )]      Stack<T>.Enumerator                                   ? coll)                      => HasCollection(coll);
  ...
  //public static bool FilledIn<T>    ([NotNullWhen(true )]      IDictionary<T,U>                                      ? coll)                      => HasCollection(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      IEnumerable<T>                                        ? coll)                      => HasEnumerable(coll);
  //public static bool FilledIn<T>    ([NotNullWhen(true )]      IEnumerator<T>                                        ? coll)                      => HasCollection(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      IList<T>                                              ? coll)                      => HasCollection(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      IReadOnlyCollection<T>                                ? coll)                      => HasEnumerable(coll);
    public static bool FilledIn<T,U>  ([NotNullWhen(true )]      IReadOnlyDictionary<T,U>                              ? coll)                      => HasEnumerable(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      IReadOnlyList<T>                                      ? coll)                      => HasEnumerable(coll);
  //public static bool FilledIn<T>    ([NotNullWhen(true )]      IReadOnlySet<T>                                       ? coll)                      => HasCollection(coll);
    ...
    public static bool FilledIn<T>    ([NotNullWhen(true )]      ObjectModel.ReadOnlyCollection<T>                     ? coll)                      => HasCollection(coll);
    public static bool FilledIn<T,U>  ([NotNullWhen(true )]      ObjectModel.ReadOnlyDictionary<T,U>                   ? coll) where T : notnull    => HasCollection(coll);
    public static bool FilledIn<T,U>  ([NotNullWhen(true )]      ObjectModel.ReadOnlyDictionary<T,U>.KeyCollection     ? coll) where T : notnull    => HasCollection(coll);
    public static bool FilledIn<T,U>  ([NotNullWhen(true )]      ObjectModel.ReadOnlyDictionary<T,U>.ValueCollection   ? coll) where T : notnull    => HasCollection(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      ObjectModel.ReadOnlyObservableCollection<T>           ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T>    ([NotNullWhen(true )]      ObjectModel.ReadOnlySet<T>                            ? coll)                      => HasCollection(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      Concurrent.BlockingCollection<T>                      ? coll)                      => HasEnumerable(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      ConcurrentBag<T>                                      ? coll)                      => HasEnumerable(coll);
    public static bool FilledIn<T,U>  ([NotNullWhen(true )]      ConcurrentDictionary<T,U>                             ? coll) where T : notnull    => HasCollection(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      ConcurrentQueue<T>                                    ? coll)                      => HasEnumerable(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      ConcurrentStack<T>                                    ? coll)                      => HasEnumerable(coll);
  //public static bool FilledIn<T,U,V>([NotNullWhen(true )]      ConcurrentDictionary<T,U>.AlternateLookup<V>          ? coll)                      => HasCollection(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      Concurrent.IProducerConsumerCollection<T>             ? coll)                      => HasEnumerable(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      Specialized.HybridDictionary                          ? coll)                      => HasCollection_NonGeneric(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      Specialized.ListDictionary                            ? coll)                      => HasCollection_NonGeneric(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      Specialized.NameObjectCollectionBase                  ? coll)                      => HasCollection_NonGeneric(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      Specialized.NameObjectCollectionBase.KeysCollection   ? coll)                      => HasCollection_NonGeneric(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      Specialized.NameValueCollection                       ? coll)                      => HasCollection_NonGeneric(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      Specialized.OrderedDictionary                         ? coll)                      => HasCollection_NonGeneric(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      Specialized.StringCollection                          ? coll)                      => HasCollection_NonGeneric(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      Specialized.StringDictionary                          ? coll)                      => HasEnumerable_NonGeneric(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      Specialized.StringEnumerator                          ? coll)                      => Has_StringEnumerator(coll);
    public static bool FilledIn<T>    ([NotNullWhen(true )]      Specialized.IOrderedDictionary                        ? coll)                      => HasCollection_NonGeneric(coll);
    ...
    public static bool FilledIn<T>    ([NotNullWhen(true )]      ImmutableStack<T>                                     ? coll)                      => HasEnumerable(coll);
  //public static bool FilledIn<T>    ([NotNullWhen(true )]      ImmutableArray<T>.Enumerator                          ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T>    ([NotNullWhen(true )]      ImmutableArray<T>                                     ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T,U>  ([NotNullWhen(true )]      ImmutableDictionary<T,U>.Enumerator                   ? coll)                      => HasEnumerator(coll);
  //public static bool FilledIn<T>    ([NotNullWhen(true )]      ImmutableHashSet<T>.Enumerator                        ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T>    ([NotNullWhen(true )]      ImmutableList<T>.Enumerator                           ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T>    ([NotNullWhen(true )]      ImmutableQueue<T>.Enumerator                          ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T,U>  ([NotNullWhen(true )]      ImmutableSortedDictionary<T,U>.Enumerator             ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T>    ([NotNullWhen(true )]      ImmutableSortedSet<T>.Enumerator                      ? coll)                      => HasCollection(coll);
  //public static bool FilledIn<T>    ([NotNullWhen(true )]      ImmutableStack<T>.Enumerator                          ? coll)                      => HasCollection(coll);
