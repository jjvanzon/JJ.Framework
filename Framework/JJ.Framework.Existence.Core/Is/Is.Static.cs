...
public static partial class FilledInHelper
{
    ...
    /// <inheritdoc cref="_is" />
    public static bool Is(     bool         spaceMatters, string? a, string? b, [Implic(Reason = NameOvl)] int dummy = 0) => IsUtil.Is(a, b, spaceMatters: spaceMatters);
    /// <inheritdoc cref="_is" />
    ...
    /// <inheritdoc cref="_is" />
    public static bool Is(     bool spaceMatters, bool caseMatters,  string? a, string? b, [Implic(Reason = NameOvl)] int dummy = 0) => IsUtil.Is(a, b, caseMatters,  spaceMatters);
}