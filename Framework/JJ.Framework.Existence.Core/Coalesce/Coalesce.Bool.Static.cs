...
[Prio(-1)] public static bool   Coalesce   (     bool? val, bool? fallback, bool        zeroMatters, NameOvl ovl = default) => CoalesceTwoNullyVals(val, fallback, zeroMatters);
           /// <inheritdoc cref="_coalesce" />
[Prio(-1)] public static bool   Coalesce   (     bool? val, bool  fallback, bool        zeroMatters, NameOvl ovl = default) => CoalesceNullyAndVal (val, fallback, zeroMatters);
           /// <inheritdoc cref="_coalesce" />
...
[Prio(-1)] public static bool   Coalesce   (     bool? val, bool? fallback, bool? fallback2, bool        zeroMatters, NameOvl ovl = default) => CoalesceNullyAndVal(val, CoalesceTwoNullyVals(fallback, fallback2, zeroMatters), zeroMatters);
           /// <inheritdoc cref="_coalesce" />
[Prio(-1)] public static bool   Coalesce   (     bool? val, bool? fallback, bool  fallback2, bool        zeroMatters, NameOvl ovl = default) => CoalesceNullyAndVal(val, CoalesceNullyAndVal (fallback, fallback2, zeroMatters), zeroMatters);
           /// <inheritdoc cref="_coalesce" />
[Prio(-1)] public static bool   Coalesce   (     bool? val, bool  fallback, bool? fallback2, bool        zeroMatters, NameOvl ovl = default) => CoalesceNullyAndVal(val, CoalesceValAndNully (fallback, fallback2, zeroMatters), zeroMatters);
           /// <inheritdoc cref="_coalesce" />
[Prio(-1)] public static bool   Coalesce   (     bool? val, bool  fallback, bool  fallback2, bool        zeroMatters, NameOvl ovl = default) => CoalesceNullyAndVal(val, CoalesceTwoVals     (fallback, fallback2, zeroMatters), zeroMatters);
           /// <inheritdoc cref="_coalesce" />
[Prio(-1)] public static bool   Coalesce   (     bool  val, bool? fallback, bool? fallback2, bool        zeroMatters, NameOvl ovl = default) => CoalesceTwoVals    (val, CoalesceTwoNullyVals(fallback, fallback2, zeroMatters), zeroMatters);
           /// <inheritdoc cref="_coalesce" />
[Prio(-1)] public static bool   Coalesce   (     bool  val, bool? fallback, bool  fallback2, bool        zeroMatters, NameOvl ovl = default) => CoalesceTwoVals    (val, CoalesceNullyAndVal (fallback, fallback2, zeroMatters), zeroMatters);
           /// <inheritdoc cref="_coalesce" />
...
[Prio(-1)] public static bool   Coalesce   (     bool  val, bool  fallback, bool  fallback2, bool        zeroMatters, NameOvl ovl = default) => CoalesceTwoVals    (val, CoalesceTwoVals     (fallback, fallback2, zeroMatters), zeroMatters);
         ...
         //public static bool   Coalesce   (     bool         zeroMatters, bool    val,  bool    fallback, bool    fallback2 )                                                   => CoalesceTwoVals       (val,  CoalesceTwoVals       (fallback, fallback2, zeroMatters), zeroMatters);
           ...
           // TODO: Make more efficient by not calling the `Many` variant.
