...
public static partial class FilledInExtensions
{
    ...
    /// <inheritdoc cref="_filledin" />
    public static bool FilledIn     ([NotNullWhen(true )] this bool           boolean                             )                  => HasBool     (boolean                );
    /// <inheritdoc cref="_filledin" />
    public static bool FilledIn     ([NotNullWhen(true )] this bool           boolean,   bool         zeroMatters )                  => HasBool     (boolean,   zeroMatters );
    /// <inheritdoc cref="_filledin" />
    public static bool FilledIn     ([NotNullWhen(true )] this bool           boolean,   ZeroMatters  zeroMatters )                  => HasBool     (boolean,   zeroMatters );
    /// <inheritdoc cref="_filledin" />
    public static bool FilledIn     ([NotNullWhen(true )] this bool?          nullyBool                           )                  => HasBoolNully(nullyBool              );
    /// <inheritdoc cref="_filledin" />
    public static bool FilledIn     ([NotNullWhen(true )] this bool?          nullyBool, bool         zeroMatters )                  => HasBoolNully(nullyBool, zeroMatters );
    /// <inheritdoc cref="_filledin" />
    public static bool FilledIn     ([NotNullWhen(true )] this bool?          nullyBool, ZeroMatters  zeroMatters )                  => HasBoolNully(nullyBool, zeroMatters );
    /// <inheritdoc cref="_filledin" />
