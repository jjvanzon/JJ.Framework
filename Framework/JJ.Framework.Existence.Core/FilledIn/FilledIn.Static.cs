...
public static partial class FilledInHelper
{
    ...
    /// <inheritdoc cref="_filledin" />
    public static bool FilledIn     ([NotNullWhen(true )]       bool           val                                )                  => HasBool     (val                   );
    /// <inheritdoc cref="_filledin" />
    public static bool FilledIn     ([NotNullWhen(true )]       bool           val,      bool         zeroMatters )                  => HasBool     (val,      zeroMatters );
    /// <inheritdoc cref="_filledin" />
    public static bool FilledIn     ([NotNullWhen(true )]       bool           val,      ZeroMatters  zeroMatters )                  => HasBool     (val,      zeroMatters );
    /// <inheritdoc cref="_filledin" />
    public static bool FilledIn     ([NotNullWhen(true )]       bool?          nullyVal                           )                  => HasBoolNully(nullyVal              );
    /// <inheritdoc cref="_filledin" />
    public static bool FilledIn     ([NotNullWhen(true )]       bool?          nullyVal, bool         zeroMatters )                  => HasBoolNully(nullyVal, zeroMatters );
    /// <inheritdoc cref="_filledin" />
    public static bool FilledIn     ([NotNullWhen(true )]       bool?          nullyVal, ZeroMatters  zeroMatters )                  => HasBoolNully(nullyVal, zeroMatters );
    /// <inheritdoc cref="_filledin" />
    ...
    // Ambiguous:
    ///// <inheritdoc cref="_filledin" />
    //public static bool FilledIn   (bool         zeroMatters,  [NotNullWhen(true )]      bool           val      )                 => HasBool     (val,      zeroMatters );
    /// <inheritdoc cref="_filledin" />
    public static bool FilledIn     (ZeroMatters  zeroMatters,  [NotNullWhen(true )]     bool           val       )                  => HasBool     (val,      zeroMatters );
    /// <inheritdoc cref="_filledin" />
    public static bool FilledIn     (bool         zeroMatters,  [NotNullWhen(true )]     bool?          nullyVal  )                  => HasBoolNully(nullyVal, zeroMatters );
    /// <inheritdoc cref="_filledin" />
    public static bool FilledIn     (ZeroMatters  zeroMatters,  [NotNullWhen(true )]     bool?          nullyVal  )                  => HasBoolNully(nullyVal, zeroMatters );
    /// <inheritdoc cref="_filledin" />
