...
public static partial class FilledInHelper
{
    ...
    /// <inheritdoc cref="_filledin" />
    public static bool FilledIn<T>  (                    bool           zeroMatters,  [NotNullWhen(true)] T            valOrObj    ) where T : struct => HasVal(valOrObj, zeroMatters);
    /// <inheritdoc cref="_filledin" />
    public static bool FilledIn<T>  (                    ZeroMatters    zeroMatters,  [NotNullWhen(true)] T            valOrObj    ) where T : struct => HasVal(valOrObj, zeroMatters);
    /// <inheritdoc cref="_filledin" />
