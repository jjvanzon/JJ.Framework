...
namespace JJ.Framework.Reflection.Tests.ReflectionCacheTests
{
    ...
    public class ReflectionCacheTests
    {
        ...
        public void Test_ReflectionCache_GetMethod_NonRefParameter_Succeeds()
        {
            ...
            string methodName = nameof(ReflectionCacheTests_HelperClass.Method_NonRefParameter);
        ...
        {
            Type type = typeof(ReflectionCacheTests_HelperClass);
            string methodName = nameof(ReflectionCacheTests_HelperClass.Method_OutParameter);
        ...
        {
            Type type = typeof(ReflectionCacheTests_HelperClass);
            string methodName = nameof(ReflectionCacheTests_HelperClass.Method_WithTypeArguments);
