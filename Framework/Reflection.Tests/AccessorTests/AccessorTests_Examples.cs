...
namespace JJ.Framework.Reflection.Tests.AccessorTests
{
    ...
    public class AccessorTests_Examples
    {
        ...
        [TestMethod]
        public void Accessor_Construction_WithObject_Example()
        {
        ...
        [TestMethod]
        public void Accessor_Construction_WithType_Example()
        {
            var accessor = new Accessor(typeof(MyStaticClass));
        }
        
        [TestMethod]
        public void Accessor_Construction_WithObjectAndType_Example()
        {
            var myObject = new MyClass();
        ...
        [TestMethod]
        public void Accessor_Construction_BaseAndDerived_Example()
        { 
            var myObject = new MyClass();
        ...
        [TestMethod]
        public void Accessor_Construction_WithTypeName_Example()
        {
            var myObject = new MyClass();
        ...
        //[TestMethod]
        //public void Accessor_Wrapper_Example()
        //{
