...
//            NestedEnumerator topNestedEnumerator = null;
//            NestedEnumerator nestedEnumerator = null;

//            foreach (IEnumerable<TItem> collection in collectionsList)
//            {
//                nestedEnumerator = new NestedEnumerator(collection, nestedEnumerator);
//                if (topNestedEnumerator == null)
//                {
//                    topNestedEnumerator = nestedEnumerator;
//                }
//            }
...
//            topNestedEnumerator.Enumerate();

//            return GetEnumerator();

//            IEnumerable<int> Callback()
//            {
...
//            void callback(object[] items) => yield  return resultSelector(items);

//            topNestedEnumerator.Callback = callback;
//        }
