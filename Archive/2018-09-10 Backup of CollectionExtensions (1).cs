...
//            var itemCombinations = new List<TItem[]>();

//            var indices = new int[collectionsCount];
...
//            {
//                var collection = collectionsList[collectionIndex].ToArray();

//                for (int itemIndex = 0; itemIndex < collection.Count; itemIndex++)
//                {
//                    TItem item = collection[itemIndex];
