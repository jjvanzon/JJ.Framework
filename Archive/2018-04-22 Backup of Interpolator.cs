...
//		/// http://www.virtualdj.com/forums/171269/VirtualDJ_Plugins/_Release__CDJ_Vinyl_Brake_Effect.html
//		/// </summary>
//		private static short Interpolate_CubicEquidistant_Original(float x, short y1, short y2, short y3, short y4)
//		{
...
//		/// Source: http://stackoverflow.com/questions/1125666/how-do-you-do-bicubic-or-other-non-linear-interpolation-of-re-sampled-audio-da
//		/// </summary>
//		private static float Interpolate_Hermite_4pt3oX_Original(float x0, float x1, float x2, float x3, float t)
//		{
//			float c0 = x1;
//			float c1 = .5F * (x2 - x0);
//			float c2 = x0 - 2.5F * x1 + 2 * x2 - .5F * x3;
...
//			double y = Interpolate_Cubic_SmoothSlope(x0, x1, y0, y1, slope0, slope1, x);
//			return y;
//		}
...
//			double y = Interpolate_Cubic_SmoothSlope_Equidistant_FromSlopes(dx, y0, y1, slope0, slope1, x);
//			return y;
//		}

//		[MethodImpl(MethodImplOptions.AggressiveInlining)]
//		public static double Interpolate_Cubic_SmoothSlope_Equidistant_FromSlopes(
//			double dx,
//			double y0,
//			double y1,
//			double slope0,
...
//		[MethodImpl(MethodImplOptions.AggressiveInlining)]
//		public static double Interpolate_Cubic_SmoothSlope_Equidistant_FromPrecalculateVariables(
//			double y0,
//			double a,
//			double b,
//			double c,
...
//		//	double a = slope0;
//		//	double adx = a * dx;
//		//	double b = (3 * dy - dx * slope1 - 2 * adx) / dx2;
//		//	double c = (dy - adx - b * dx2) / dx3;
//		//	double y = y0 + ofs * (a + ofs * (b + ofs * c));
//		//	return y;
//		//}
//	}
