...
//        private void verify_properties()
//        {
//            # ifdef VERIFY_RBTREE
...
//        public void verify_property_1()
//        {
//            RedBlackTreeHelper.Assert(node_color() == RedBlackTreeColorEnum.Red || node_color() == RedBlackTreeColorEnum.Black);
//            verify_property_1(left);
//            verify_property_1(right);
//        }

//        public void verify_property_2()
//        {
//            RedBlackTreeHelper.Assert(node_color() == RedBlackTreeColorEnum.Black);
//        }
...
//        public void verify_property_4(RedBlackTreeNode node)
//        {
//            if (node_color() == RedBlackTreeColorEnum.Red)
//            {
//                RedBlackTreeHelper.Assert(node_color(node.left) == RedBlackTreeColorEnum.Black);
//                RedBlackTreeHelper.Assert(node_color(node.right) == RedBlackTreeColorEnum.Black);
//                RedBlackTreeHelper.Assert(node_color(node.parent) == RedBlackTreeColorEnum.Black);
//            }
//            verify_property_4(node.left);
//            verify_property_4(node.right);
//        }

//        public void verify_property_5(RedBlackTreeNode node)
//        {
//            if (node == null) throw new NullException(() => node);

//            int black_count_path = -1;
//            verify_property_5_helper(node, 0, &black_count_path);
//        }

//        void verify_property_5_helper(RedBlackTreeNode node, int black_count, int* path_black_count)
//        {
//            if (node_color() == RedBlackTreeColorEnum.Black)
//            {
//                black_count++;
//            }
//            if (node == null)
...
//                }
//                else {
//                    RedBlackTreeHelper.Assert(black_count == *path_black_count);
//                }
//                return;
//            }
