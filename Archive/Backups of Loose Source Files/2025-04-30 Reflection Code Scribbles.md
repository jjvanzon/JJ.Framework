...
public MethodInfo? Method(Type type, bool    nullable, string  name,     params Type?[] argTypes)  => MethodOrSomething(type, name, nullable,         BindingFlags, argTypes, _methodDicN, _methodDicLockN);
