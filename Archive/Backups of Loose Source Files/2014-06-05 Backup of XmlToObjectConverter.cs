...
namespace JJ.Framework.Xml
{
        ...
        where TDestObject: new()
    {
        ...
        /// </summary>
        /// <param name="sourceElement">not nullable</param>
        private void ConvertLeafElement(XmlElement sourceElement, object destParentObject, PropertyInfo destProperty)
        {
        ...
        /// </summary>
        /// <param name="sourceElement">not nullable</param>
        private void ConvertCompositeElement(XmlElement sourceElement, object destParentObject, PropertyInfo destProperty)
        {
        ...
        private void ConvertXmlArray(XmlElement sourceParentElement, object destParentObject, PropertyInfo destCollectionProperty)
        {
            ...
            for (int i = 0; i < sourceXmlArrayItems.Count; i++)
            {
                ...
                // TODO: Delegate to ConvertElement.
                if (IsLeafType(destItemType))
                {
                    string sourceValue = sourceXmlArrayItem.InnerText;
                    object destValue = ConversionHelper.ConvertValue(sourceValue, destItemType);
                    destCollection[i] = destValue;
                }
                else
                {
                    object destValue = Activator.CreateInstance(destItemType);
                    destCollection[i] = destValue;
        ...
        // TODO: This method must get a summary.
