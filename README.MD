...
- dotnet.exe CLI wrapper. Run compilations and other dotnet actions programmatically at runtime.
...
- Complete test suite guaranteeing no regressions.
- TestRunner parallel race condition fixed.
