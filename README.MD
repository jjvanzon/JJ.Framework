...
|       |                                         | Full code coverage with automated tests and corrections.
|       |                                         | Releasing a historic version `0.250.x`
|       |                                         | `EntityStatusManager` and `GetListIsDirty` for framework-agnostic flagging for New/Deleted/Dirty
